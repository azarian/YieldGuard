...
class SolarEdgeOptimizerClient:
    ...
    def authenticate(self) -> None:
        ...
        """
        # Reset session state for a clean authentication
        ...
        # Extract CSRF token and verify JSESSIONID cookies
        self._csrf_token = ""
        has_jsession = False
    ...
    def discover_optimizers(self) -> list[Optimizer]:
        ...
        url = f"{self.BASE_URL}/solaredge-apigw/api/sites/{self.site_id}/layout/logical"
